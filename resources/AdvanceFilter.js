...
Vtiger_AdvanceFilter_Js(
  ...
  {},
  {
    ...
    getFieldSpecificType: function (fieldSelected) {
      ...
      var workflowModule = jQuery("#advanceFilterContainer")
    ...
    loadConditions: function (fieldSelect) {
      ...
      if (
        this.getModuleName() == "Workflows" &&
        (fieldInfo.name == "createdby" || fieldInfo.name == "modifiedby")
      ) {
    ...
    registerConditionChange: function () {
      ...
      filterContainer.on("change", 'select[name="comparator"]', function (e) {
        ...
        var conditionFieldInput = conditionRow.find(
        ...
        if (
          $.inArray(conditionComparatorInput.val(), [
            "has changed",
            "is empty",
            "is not empty",
          ]) !== -1
        ) {
          conditionValueInputContainer
            .removeClass("visible")
            .addClass("invisible");
    ...
    getValues: function () {
      ...
      conditionGroups.each(function (index, domElement) {
        ...
        conditions.each(function (i, conditionDomElement) {
            ...
            for (var key in fieldList) {
              ...
              if (field == "value") {
                if (
                  ...
                  for (i = 0; i < valueArray.length; i++) {
                    ...
                    var dateInstance = new Date(
                      valueParts[dateFormatParts.indexOf("yyyy")],
                      parseInt(valueParts[dateFormatParts.indexOf("mm")]) - 1,
                      valueParts[dateFormatParts.indexOf("dd")]
                    );
                    if (!isNaN(dateInstance.getTime())) {
                      valueArray[i] = app.getDateInVtigerFormat(
                        "yyyy-mm-dd",
                        dateInstance
                      );
                    }
                ...
                // Modified by Hieu Nguyen on 2021-05-19 to get unformatted value of numeric fields
                  ...
                  rowValues[field] = app.unformatCurrencyToUser(
          ...
          if (
            jQuery('[name="valuetype"]', rowElement).val() == "false" ||
            jQuery('[name="valuetype"]', rowElement).length == 0
          ) {
    ...
    getFieldSpecificUi: function (fieldSelectElement) {
      ...
      if (
        jQuery.inArray(
          ...
          this.comparatorsWithNoValueBoxMap
        ) != -1
      ) {
        return jQuery("");
      } else {
...
Vtiger_Field_Js(
  ...
  {},
  {
    ...
    getUi: function () {
      var html =
        '<input type="text" class="getPopupUi inputElement" name="' +
        this.getName() +
...
Workflows_Field_Js(
  "Workflows_Text_Field_Js",
  {},
  {
    getUi: function () {
      var html =
        '<textarea class="getPopupUi textarea inputElement" name="' +
        this.getName() +
        '" value="">' +
        this.getValue() +
        "</textarea>" +
  ...
  {},
  {
    ...
    getUi: function () {
      ...
      if (comparatorSelectedOptionVal.length > 0) {
        if (
          comparatorSelectedOptionVal == "between" ||
          comparatorSelectedOptionVal == "custom"
        ) {
          var html =
            '<div class="date"><input class="dateField inputElement" style="width:auto;" data-calendar-type="range" name="' +
            this.getName() +
            '" data-date-format="' +
            this.getDateFormat() +
          ...
          var html =
            ...
            '" type="text" value="' +
            this.getValue() +
            '" data-validation-engine="validate[funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" data-validator="[{"name":"PositiveNumber"}]">\n\
							<input type="hidden" name="valuetype" value="' +
            this.get("workflow_valuetype") +
            '" />';
          return jQuery(html);
          ...
          var startValue =
            dateSpecificConditions[comparatorSelectedOptionVal]["startdate"];
          var endValue =
            dateSpecificConditions[comparatorSelectedOptionVal]["enddate"];
          var html =
            '<input name="' +
            this.getName() +
            '"  type="text" ReadOnly="true" value="' +
          ...
          comparatorSelectedOptionVal == "is today" ||
          comparatorSelectedOptionVal == "is tomorrow" ||
          comparatorSelectedOptionVal == "is yesterday"
        ) {
          //show nothing
        } else {
          return this._super();
        ...
        var html =
          '<input type="text" class="getPopupUi date inputElement" name="' +
          this.getName() +
          '"  data-date-format="' +
          this.getDateFormat() +
          '"  value="' +
    ...
    getUi: function () {
      ...
      if (this._specialDateTimeComparator(comparatorSelectedOptionVal)) {
        var html =
          '<input name="' +
          this.getName() +
          '" class="inputElement" type="text" value="' +
          this.getValue() +
        ...
        var html =
          '<input type="text" class="getPopupUi datetime inputElement" name="' +
          this.getName() +
          '"  data-date-format="' +
          this.getDateFormat() +
          '"  value="' +
...
Vtiger_Currency_Field_Js(
  ...
  {},
  {
    getUi: function () {
      var html =
        '<input type="text" class="getPopupUi marginLeftZero currency inputElement" name="' +
        this.getName() +
        '" value="' +
        this.getValue() +
        '"  />' +
...
Vtiger_Time_Field_Js(
  ...
  {},
  {
    ...
    getUi: function () {
      var html =
        '<input type="text" class="getPopupUi time inputElement" name="' +
        this.getName() +
        '"  value="' +
        this.getValue() +
        '" />' +
...
Vtiger_Field_Js(
  ...
  {},
  {
    ...
    getUi: function () {
      var html =
        '<input type="text" class="getPopupUi percent inputElement" name="' +
        this.getName() +
        '" value="' +
        this.getValue() +
        '" />' +
...
Vtiger_Field_Js(
  ...
  {},
  {
    ...
    getUi: function () {
      var html =
        '<input type="text" class="getPopupUi text inputElement" name="' +
        this.getName() +
        '" value="' +
        this.getValue() +
        '" />' +
...
Vtiger_Field_Js(
  ...
  {},
  {
    ...
    getUi: function () {
      var html =
        '<input type="text" class="getPopupUi boolean inputElement" name="' +
        this.getName() +
        '" value="' +
        this.getValue() +
        '" />' +
...
Vtiger_Owner_Field_Js(
  ...
  {},
  {
    getUi: function () {
      var html =
        '<select class="inputElement select2" name="' + this.getName() + '">';
...
Vtiger_Owner_Field_Js(
  "Workflows_Ownergroup_Field_Js",
  {},
  {
    getUi: function () {
      var html =
        '<select class="select2 inputElement" name="' +
        this.getName() +
        '" id="field_' +
        this.getModuleName() +
        "_" +
...
Vtiger_Picklist_Field_Js(
  ...
  {},
  {
    getUi: function () {
      ...
      var html =
        '<input type="hidden" class="inputElement select2" name="' +
        this.getName() +
        '" id="' +
        this.getName() +
        '">';
...
Vtiger_Multipicklist_Field_Js(
  "Workflows_Multipicklist_Field_Js",
  {},
  {
    getUi: function () {
      var pickListValues = this.getPickListValues();
      ...
      selectedOptionsValue = selectedOptionsValue.substring(
        0,
        selectedOptionsValue.lastIndexOf(",")
      );
      var html =
        '<input type="hidden" class="col-lg-12 select2" name="' +
        this.getName() +
        '[]" id="' +
        this.getName() +
