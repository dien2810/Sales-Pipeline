<?php
class Settings_PipelineConfig_PipelineAndConditionRowAjax_View extends CustomView_Base_View{
    ...
    function process(Vtiger_Request $request){
        ...
        $result = $viewer->fetch('modules/Settings/PipelineConfig/tpls/PipelineAndConditionRow.tpl');
